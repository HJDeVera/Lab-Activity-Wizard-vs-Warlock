public class App {
    public static void main(String[] args) throws Exception {
        ...
        Wizard Shuna = new Wizard("Shuna");
        Warlock Shion = new Warlock("Shion");
        ...
        System.out.println("\n");
        Shuna.executionerRay(Shion);
        Shion.status(60, 200);
        Shuna.status(100, 160);

        Shion.scriptFlare(Shuna);
        Shion.status(60, 165);
        Shuna.status(65, 160);
        Shion.restore(Shion, 20, 20);
        Shion.status(80, 185);
        Shuna.status(65, 160);

        Shuna.acidRain(Shion);
        Shion.status(30, 185);
        Shuna.status(65, 110);
        Shion.thunderFlash(Shuna);
        Shion.status(30, 135);
        Shuna.status(15, 110);
        Shuna.executionerRay(Shion);
        Shion.status(0, 135);
        ...
        System.out.println("The winner is Wizard Shuna");
        System.out.println("Wizard Shuna will level up!!");
